/* oxlint-disable react-doctor/no-giant-component -- catalog search, filtering, and payload drilldown share one coordinated view model. */
/* oxlint-disable react-doctor/prefer-useReducer -- state fields represent independent UI controls rather than reducer events. */
/* oxlint-disable react-doctor/jsx-max-depth -- payload drilldown UI is intentionally nested to preserve accordion semantics and layout grouping. */
"use client";
...
import { HighlightedJson } from "@/components/templates/HighlightedJson";
...
export function TemplateCatalogPage() {
  ...
  const groupedItems = useMemo(() => {
    const groups = new Map<TaskCategory, TemplateDocumentationItem[]>();
                      ...
                      <CardContent className="space-y-5">
                        <div className="space-y-2">
                          <label
                            ...
                            className="text-xs font-mono uppercase tracking-[0.24em] text-muted-foreground"
                          >
                            Search
                          </label>
