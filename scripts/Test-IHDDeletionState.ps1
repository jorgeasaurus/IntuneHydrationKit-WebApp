...
<#
.SYNOPSIS
Checks a tenant for leftover Intune Hydration Kit objects.
...
"Imported by Intune Hydration Kit" description marker is reported as leftover.
...
Includes the matching item details in the returned object output.

.EXAMPLE
./scripts/Test-IHDDeletionState.ps1 -TenantId '00000000-0000-0000-0000-000000000000' -UseDeviceCode
#>
...
$leftoverCount = ($summary | Measure-Object -Property LeftoverCount -Sum).Sum
